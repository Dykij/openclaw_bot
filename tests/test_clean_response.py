"""Unit tests for clean_response_for_user and sanitize_file_content"""
import sys
import os
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from src.pipeline_utils import clean_response_for_user, sanitize_file_content
...
def test_sanitize_file_content():
    ...
    sanitized = sanitize_file_content(content)
