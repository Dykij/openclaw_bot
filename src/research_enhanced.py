"""
Enhanced Research Pipeline for OpenClaw.

Improvements inspired by EvoScientist (multi-agent AI scientists),
evidence quality scoring heuristics, cross-validation, and
research quality metrics.

Classes:
- MultiPerspectiveResearcher: advocate/critic/synthesizer pipeline
- EvidenceQualityScorer: heuristic evidence scoring (no LLM)
- CrossValidator: claim extraction + cross-source validation
- ResearchQualityMetrics: coverage, depth, consistency metrics
"""
